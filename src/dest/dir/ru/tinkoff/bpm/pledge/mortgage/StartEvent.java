 ...
 */
package ru.tinkoff.bpm.pledge.mortgage;
...
public class StartEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public StartEvent(java.lang.String appIntId, java.lang.String parentIntId, java.lang.String pledgeIntId, java.lang.Integer partnerId) {
   ...
   */
  public static ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder newBuilder() {
    return new ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder();
  }
   ...
   * @return A new StartEvent RecordBuilder
   */
  public static ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder newBuilder(ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder other) {
    if (other == null) {
      return new ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder();
    } else {
      return new ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder(other);
    }
  }
   ...
   * @return A new StartEvent RecordBuilder
   */
  public static ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder newBuilder(ru.tinkoff.bpm.pledge.mortgage.StartEvent other) {
    if (other == null) {
      return new ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder();
    } else {
      return new ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StartEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ru.tinkoff.bpm.pledge.mortgage.StartEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.appIntId)) {
        this.appIntId = data().deepCopy(fields()[0].schema(), other.appIntId);
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder setAppIntId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder clearAppIntId() {
      appIntId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder setParentIntId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder clearParentIntId() {
      parentIntId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder setPledgeIntId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder clearPledgeIntId() {
      pledgeIntId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder setPartnerId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ru.tinkoff.bpm.pledge.mortgage.StartEvent.Builder clearPartnerId() {
